...
#for i in `seq 455000 5000 495000`
#do
##  echo $i
#  echo gen_${i}.pth
...
##  echo $i
#  echo gen_${i}.pth
#  CUDA_VISIBLE_DEVICES=1 python evaluate.py --model lite-MFN --ckpt release_model/lite-MFN_KITTI360EX-I_large-MFN-T1C1-LastMem-csT-deco-csfv2-Mix-d9/gen_${i}.pth --dataset KITTI360-EX --data_root datasets//KITTI-360EX//InnerSphere --fov fov5 --past_ref --timing --memory --output_size 336 336 --model_win_size 7 7 --model_output_size 84 84
#  CUDA_VISIBLE_DEVICES=1 python evaluate.py --model lite-MFN --ckpt release_model/lite-MFN_KITTI360EX-I_large-MFN-T1C1-LastMem-csT-deco-csfv2-Mix-d9/gen_${i}.pth --dataset KITTI360-EX --data_root datasets//KITTI-360EX//InnerSphere --fov fov10 --past_ref --timing --memory --output_size 336 336 --model_win_size 7 7 --model_output_size 84 84
#  CUDA_VISIBLE_DEVICES=1 python evaluate.py --model lite-MFN --ckpt release_model/lite-MFN_KITTI360EX-I_large-MFN-T1C1-LastMem-csT-deco-csfv2-Mix-d9/gen_${i}.pth --dataset KITTI360-EX --data_root datasets//KITTI-360EX//InnerSphere --fov fov20 --past_ref --timing --memory --output_size 336 336 --model_win_size 7 7 --model_output_size 84 84
#done
