...
for i in `seq 382500 2500 387500`
do
#  echo $i
  echo gen_${i}.pth
  CUDA_VISIBLE_DEVICES=1 python evaluate.py --model lite-MFN --ckpt release_model/FlowLens_v2_ubuntu/gen_${i}.pth --dataset davis --data_root datasets/ --timing --memory --same_memory --good_fusion
done